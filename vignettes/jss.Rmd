...
```{tikz, uni-adm, fig.cap = "Add a figure caption.", fig.ext = "png", cache = TRUE, echo = FALSE, out.width = "50%"}
...
```{tikz, rel-edu, fig.cap = "Add a figure caption.", fig.ext = "png", cache = TRUE, echo = FALSE, engine.opts=list(extra.preamble = c("\\usepackage{pgfplots}", "\\pgfplotsset{compat=1.17}"))}
...
The hypothesized causal graph for the dataset is given in Figure \ref{fig:census-tikz}. We construct the causal graph and the confounding matrix:
...
<!-- add a sentence to not have titles follow each other directly -->
...
```{tikz, semi-markov, fig.cap = "Add a figure caption.", fig.ext = "png", cache = TRUE, echo = FALSE, out.width = "50%"}
