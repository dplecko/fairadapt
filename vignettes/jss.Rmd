...
ggraph(graphModel(uni_tmp), "igraph", algorithm = "sugiyama") +
  ...
  geom_nodetext(aes(x = x, y = y, label = name), size = 5) +
  theme_blank(plot.margin = margin(30, 30, 30, 30)) +
