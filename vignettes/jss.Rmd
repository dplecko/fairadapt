...
\begin{enumerate}[label=(\arabic*)]
  ...
  \item \textit{calibration} \citep{chouldechova2017fair} requires the protected attribute to be independent of the actual outcome given the prediction. Intuitively, this means that the protected attribute $A$ does not offer additional information about the outcome $Y$ once we know what the prediction $\widehat{Y}$ is. 
\end{enumerate}
