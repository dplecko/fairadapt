...
There are two considerations when influencing the fit. Run-time and quality of fit.

#### Computational.

options in ranger / rq / mcqrnn

#### Fit Quality.

introduce an S3 method for extracting the fit; show how it can be done on uni admission example.
